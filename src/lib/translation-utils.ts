...
const HOLIDAY_NAME_MAPPING: Record<string, string> = {
  ...
  // 아시아 공휴일
  "Vesak Day": "common.vesakDay",
  "Chinese New Year": "common.chineseNewYear",
  "Hari Raya Puasa": "common.hariRayaPuasa",
  "Hari Raya Haji": "common.hariRayaHaji",
  "Deepavali": "common.deepavali",
  "Diwali": "common.deepavali",
  "Thaipusam": "common.thaipusam",
  "Dragon Boat Festival": "common.dragonBoatFestival",
  "Qingming Festival": "common.qingmingFestival",
  "Double Ninth Festival": "common.doubleNinthFestival",
  "Lantern Festival": "common.lanternFestival",
  "Hungry Ghost Festival": "common.hungryGhostFestival",
  // 아프리카 및 기타 국가 공휴일
