// 컴파일된 Holiday API 클라이언트 테스트
const { HolidayApiClient } = require('./dist/lib/holiday-api.js');
const { HolidayDataCollector } = require('./dist/lib/holiday-data-collector.js');

async function testCompiledHolidayClient() {
  console.log('🚀 컴파일된 Holiday API 클라이언트 테스트 시작...\n');
